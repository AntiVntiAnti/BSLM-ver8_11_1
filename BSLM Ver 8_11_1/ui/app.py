...
class MainWindow(FramelessWindow, QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def app_operations(self):
        ...
        try:
            ...
            self.actionInjectTime.triggered.connect(self.inject_time_method)
    ...
    def inject_date(self):
        try:
            ...
            if isinstance(focused_widget, QTextEdit):
                ...
                cursor.insertHtml(
                    f"""
                    <h3 style="font:20 11pt 'Helvetica Neue';">{current_date}</h3>
                    """)
        except Exception as e:
            logger.error(f"{e}", exc_info=True)
            
    def inject_time_method(self):
        """
        ...
        try:
            ...
            if isinstance(focused_widget, QTextEdit):
                ...
                cursor.insertHtml(
                    f"""
                    <h2 style="font:15 11pt 'Helvetica';">
                        <sup>
                            it.
                        </sup>
                        <sub>
    ...
    def switch_page_view_setup(self):
        try:
            view_switch = {
                self.actionViewNotePage: self.switch_quick_note_page,

# Form implementation generated from reading ui file 'BSLM8.10.ui'
#
...
"")
        ...
        self.quickNotePage = QtWidgets.QWidget()
        self.quickNotePage.setObjectName("quickNotePage")
        self.gridLayout_27 = QtWidgets.QGridLayout(self.quickNotePage)
        self.gridLayout_27.setContentsMargins(8, 8, 8, 8)
        self.gridLayout_27.setSpacing(0)
        self.gridLayout_27.setObjectName("gridLayout_27")
        self.quickTextEdit = QtWidgets.QTextEdit(parent=self.quickNotePage)
        self.quickTextEdit.setStyleSheet("font: 10pt \"Helvetica Neue\";")
        self.quickTextEdit.setTabStopDistance(18.0)
        self.quickTextEdit.setObjectName("quickTextEdit")
        self.gridLayout_27.addWidget(self.quickTextEdit, 0, 0, 1, 1)
        self.mainStack.addWidget(self.quickNotePage)
...
"    ")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/newPrefix/blueShowerhead.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon6.addPixmap(QtGui.QPixmap(":/newPrefix/Mac App icon 30.png"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.On)
...
"    ")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/newPrefix/blueteeth.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"    ")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/newPrefix/blueYogai.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon8.addPixmap(QtGui.QPixmap(":/newPrefix/basicsWh.png"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.On)
...
"    background-color: #121212;\n"
"    border: none;\n"
"    margin-left:12px;    color:#fff;    min-width:35px;\n"
"}\n"
"\n"
"QTabBar::tab:!selected {\n"
"    background-color: #121212;    color:#fff;\n"
...
"")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 273, 15))
        ...
        self.menuNote = QtWidgets.QMenu(parent=self.menubar)
        self.menuNote.setObjectName("menuNote")
        self.menuFormatters = QtWidgets.QMenu(parent=self.menuNote)
        self.menuFormatters.setObjectName("menuFormatters")
        self.menuBasic = QtWidgets.QMenu(parent=self.menuFormatters)
        self.menuBasic.setObjectName("menuBasic")
        self.menuAlignment = QtWidgets.QMenu(parent=self.menuFormatters)
        self.menuAlignment.setObjectName("menuAlignment")
        self.menuColor = QtWidgets.QMenu(parent=self.menuFormatters)
        self.menuColor.setObjectName("menuColor")
        self.menuInjections = QtWidgets.QMenu(parent=self.menuNote)
        self.menuInjections.setObjectName("menuInjections")
        ...
        self.actionCommitMentals = QtGui.QAction(parent=MainWindow)
        self.actionCommitMentals.setObjectName("actionCommitMentals")
        self.actionViewNotePage = QtGui.QAction(parent=MainWindow)
        self.actionViewNotePage.setObjectName("actionViewNotePage")
        ...
        self.action_bold = QtGui.QAction(parent=MainWindow)
        self.action_bold.setObjectName("action_bold")
        self.action_italic = QtGui.QAction(parent=MainWindow)
        self.action_italic.setObjectName("action_italic")
        self.action_underline = QtGui.QAction(parent=MainWindow)
        self.action_underline.setObjectName("action_underline")
        self.action_strikethrough = QtGui.QAction(parent=MainWindow)
        self.action_strikethrough.setObjectName("action_strikethrough")
        self.action_subscript = QtGui.QAction(parent=MainWindow)
        self.action_subscript.setObjectName("action_subscript")
        self.action_superscript = QtGui.QAction(parent=MainWindow)
        ...
        self.action_center = QtGui.QAction(parent=MainWindow)
        self.action_center.setObjectName("action_center")
        self.action_justify = QtGui.QAction(parent=MainWindow)
        self.action_justify.setObjectName("action_justify")
        self.action_left_align = QtGui.QAction(parent=MainWindow)
        self.action_left_align.setObjectName("action_left_align")
        self.action_right_align = QtGui.QAction(parent=MainWindow)
        self.action_right_align.setObjectName("action_right_align")
        self.action_highlight = QtGui.QAction(parent=MainWindow)
        self.action_highlight.setObjectName("action_highlight")
        self.action_color = QtGui.QAction(parent=MainWindow)
        ...
        self.menuViews.addAction(self.actionViewNotePage)
        ...
        self.menuCommits.addAction(self.actionCommitMentals)
        ...
        self.menuBasic.addAction(self.action_bold)
        self.menuBasic.addAction(self.action_italic)
        self.menuBasic.addAction(self.action_underline)
        self.menuBasic.addAction(self.action_strikethrough)
        self.menuBasic.addAction(self.action_subscript)
        self.menuBasic.addAction(self.action_superscript)
        self.menuBasic.addAction(self.action_increase_font_size)
        self.menuBasic.addAction(self.action_decrease_font_size)
        self.menuAlignment.addAction(self.action_center)
        self.menuAlignment.addAction(self.action_justify)
        self.menuAlignment.addAction(self.action_left_align)
        self.menuAlignment.addAction(self.action_right_align)
        self.menuColor.addAction(self.action_highlight)
        self.menuColor.addAction(self.action_color)
        self.menuFormatters.addAction(self.menuBasic.menuAction())
        self.menuFormatters.addAction(self.menuAlignment.menuAction())
        self.menuFormatters.addAction(self.menuColor.menuAction())
        self.menuInjections.addAction(self.actionInjectTime)
        self.menuInjections.addAction(self.actionInjectDate)
        self.menuNote.addAction(self.actionSave)
        self.menuNote.addAction(self.actionClear)
        self.menuNote.addAction(self.actionPrint)
        self.menuNote.addAction(self.menuFormatters.menuAction())
        self.menuNote.addAction(self.menuInjections.menuAction())
        ...
        self.shower_tab.setCurrentIndex(2)
        ...
        MainWindow.setTabOrder(self.lily_time, self.mental_mental_time)
        MainWindow.setTabOrder(self.mental_mental_time, self.mental_mental_date)
        MainWindow.setTabOrder(self.mental_mental_date, self.lily_notes_time)
...
" walked the wilds!"))
        ...
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_10), _translate("MainWindow", "MMDMr"))
        ...
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_11), _translate("MainWindow", "WEFE"))
        ...
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_12), _translate("MainWindow", "CSPR"))
        ...
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab_13), _translate("MainWindow", "MDMMr Table"))
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab_15), _translate("MainWindow", "WEFE Table"))
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab_14), _translate("MainWindow", "CSPR Table"))
        ...
        self.menuFormatters.setTitle(_translate("MainWindow", "Formatters"))
        ...
        self.menuInjections.setTitle(_translate("MainWindow", "Injections"))
        ...
        self.actionCommitMentals.setText(_translate("MainWindow", "Commit Mental Modules"))
        self.actionCommitMentals.setShortcut(_translate("MainWindow", "Ctrl+Shift+M"))
        self.actionViewNotePage.setText(_translate("MainWindow", "Quick Note"))
        self.actionViewNotePage.setShortcut(_translate("MainWindow", "Ctrl+1"))
        self.actionSave.setText(_translate("MainWindow", "Save Note"))
        self.actionSave.setShortcut(_translate("MainWindow", "Ctrl+S"))
        self.actionClear.setText(_translate("MainWindow", "Clear Note"))
        self.actionClear.setShortcut(_translate("MainWindow", "Meta+Ctrl+C"))
        self.actionPrint.setText(_translate("MainWindow", "Print Note"))
        self.actionPrint.setShortcut(_translate("MainWindow", "Ctrl+P"))
        self.action_bold.setText(_translate("MainWindow", "Bold"))
        self.action_bold.setShortcut(_translate("MainWindow", "Ctrl+B"))
        self.action_italic.setText(_translate("MainWindow", "Italic"))
        self.action_italic.setShortcut(_translate("MainWindow", "Ctrl+I"))
        self.action_underline.setText(_translate("MainWindow", "Underline"))
        self.action_underline.setShortcut(_translate("MainWindow", "Ctrl+U"))
        self.action_strikethrough.setText(_translate("MainWindow", "Strikethrough"))
        self.action_strikethrough.setShortcut(_translate("MainWindow", "Meta+Ctrl+S"))
        self.action_subscript.setText(_translate("MainWindow", "Subscript"))
        self.action_subscript.setShortcut(_translate("MainWindow", "Meta+Z"))
        self.action_superscript.setText(_translate("MainWindow", "Superscript"))
        self.action_superscript.setShortcut(_translate("MainWindow", "Meta+X"))
        self.action_increase_font_size.setText(_translate("MainWindow", "Increase Size"))
        self.action_increase_font_size.setShortcut(_translate("MainWindow", "Ctrl+="))
        self.action_decrease_font_size.setText(_translate("MainWindow", "Decrease Size"))
        self.action_decrease_font_size.setShortcut(_translate("MainWindow", "Ctrl+-"))
        self.action_center.setText(_translate("MainWindow", "Center"))
        self.action_center.setShortcut(_translate("MainWindow", "Meta+C"))
        self.action_justify.setText(_translate("MainWindow", "Justify"))
        self.action_justify.setShortcut(_translate("MainWindow", "Meta+J"))
        self.action_left_align.setText(_translate("MainWindow", "Left"))
        self.action_left_align.setShortcut(_translate("MainWindow", "Meta+L"))
        self.action_right_align.setText(_translate("MainWindow", "Right"))
        self.action_right_align.setShortcut(_translate("MainWindow", "Meta+R"))
        self.action_highlight.setText(_translate("MainWindow", "Hightlight"))
        self.action_highlight.setShortcut(_translate("MainWindow", "Meta+H"))
        self.action_color.setText(_translate("MainWindow", "Text Color"))
        self.action_color.setShortcut(_translate("MainWindow", "Meta+B"))
        self.actionInjectTime.setText(_translate("MainWindow", "Time"))
        self.actionInjectTime.setShortcut(_translate("MainWindow", "Meta+Shift+S"))
